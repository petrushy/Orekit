...
public class PythonFieldOfView implements FieldOfView {
     ...
     */
    @Override
    public native double getMargin();
     ...
     * can be computed from a {@link SpacecraftState}
     * as follows:
     * </p>
     * <pre>
     ...
     */
    @Override
    public native List<List<GeodeticPoint>> getFootprint(Transform fovToBody, OneAxisEllipsoid body, double angularStep);
}
