...
public class PythonTimeScales implements TimeScales {
     ...
     */
    @Override
    public native GMSTScale getGMST(IERSConventions conventions, boolean simpleEOP);
     ...
     */
    @Override
    public native AbsoluteDate getJulianEpoch();
     ...
     */
    @Override
    public native AbsoluteDate getModifiedJulianEpoch();
     ...
     */
    @Override
    public native AbsoluteDate getFiftiesEpoch();
     ...
     */
    @Override
    public native AbsoluteDate getCcsdsEpoch();
     ...
     */
    @Override
    public native AbsoluteDate getGalileoEpoch();
     ...
     */
    @Override
    public native AbsoluteDate getGpsEpoch();
     ...
     */
    @Override
    public native AbsoluteDate getQzssEpoch();
     ...
     */
    @Override
    public native AbsoluteDate getIrnssEpoch();
     ...
     */
    @Override
    public native AbsoluteDate getBeidouEpoch();
     ...
     */
    @Override
    public native AbsoluteDate getGlonassEpoch();
     ...
     */
    @Override
    public native AbsoluteDate getJ2000Epoch();
     ...
     */
    @Override
    public native AbsoluteDate getJavaEpoch();
     ...
     */
    @Override
    public native AbsoluteDate getPastInfinity();
     ...
     */
    @Override
    public native AbsoluteDate getFutureInfinity();
     ...
     */
    @Override
    public native AbsoluteDate createJulianEpoch(double julianEpoch);
     ...
     */
    @Override
    public native AbsoluteDate createBesselianEpoch(double besselianEpoch);
}
