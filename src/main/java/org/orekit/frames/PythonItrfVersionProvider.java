...
public class PythonItrfVersionProvider implements ItrfVersionProvider {
     ...
     */
    @Override
    public native ITRFVersionLoader.ITRFVersionConfiguration getConfiguration(String name, int mjd);
}
