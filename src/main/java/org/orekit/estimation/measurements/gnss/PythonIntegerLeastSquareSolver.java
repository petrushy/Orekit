...
public class PythonIntegerLeastSquareSolver implements IntegerLeastSquareSolver {
     ...
     */
    @Override
    public native IntegerLeastSquareSolution[] solveILS(int nbSol, double[] floatAmbiguities, int[] indirection, RealMatrix covariance);
}
