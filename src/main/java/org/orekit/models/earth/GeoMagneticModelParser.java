...
public class GeoMagneticModelParser {
    ...
    public List<GeoMagneticField> parse(final DataSource dataSource) throws IOException {
        ...
        final StreamTokenizer str = new StreamTokenizer(dataSource.getOpener().openReaderOnce());
     ...
     * @throws IOException if some read error occurs
     */
    private GeoMagneticField readOriginalWMMFormat(final StreamTokenizer stream) throws IOException {
