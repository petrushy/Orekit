...
public class PythonFieldShortPeriodTerms<T extends CalculusFieldElement<T>> implements FieldShortPeriodTerms<T> {
     ...
     */
    @Override
    public native T[] value(FieldOrbit<T> meanOrbit);
     ...
     */
    @Override
    public native Map<String, T[]> getCoefficients(FieldAbsoluteDate<T> date, Set<String> selected);
}
