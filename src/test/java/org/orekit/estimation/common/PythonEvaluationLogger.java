...
public class PythonEvaluationLogger<T extends ObservedMeasurement<T>> implements EvaluationLogger<T> {
     ...
     */
    @Override
    public native void log(EstimatedMeasurement<T> evaluation);
}
