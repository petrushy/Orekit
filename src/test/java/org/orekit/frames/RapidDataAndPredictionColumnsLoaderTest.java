...
public class RapidDataAndPredictionColumnsLoaderTest extends AbstractFilesLoaderTest {
    ...
    public void testMissingColumnsPadding1980() {
        ...
        Assertions.assertEquals(-67.359, 3600000 * FastMath.toDegrees(history.getEquinoxNutationCorrection(t0)[0]), 1.0e-10);
        Assertions.assertEquals(-11.755, 3600000 * FastMath.toDegrees(history.getEquinoxNutationCorrection(t0)[1]), 1.0e-10);
        ...
        Assertions.assertEquals(EopDataType.FINAL, history.getEopDataType(t0));
        ...
        Assertions.assertEquals(EopDataType.RAPID, history.getEopDataType(t1Inf));
        ...
        Assertions.assertEquals(EopDataType.RAPID, history.getEopDataType(t2Inf));
    ...
    @Test
    public void testWrongEopDataType() {
        doTestWrongFile("^finals-wrong-eop-data-type\\.daily$", 4);
    }
